...
[`elan`](https://github.com/leanprover/elan#installation) is very nice to use, especially if you're used to Rocq[^1]. It's inspired by the rust ecosystem's `rustup`, much of its API/CLI is the same. Similarly, `lake` is Lean's `cargo`.
...
:caption: `.gitignore` ing two common things
:linenos:
:lines: 28-29
```
