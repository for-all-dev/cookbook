...
If you want to follow along at home, go ahead and `echo "ANTHROPIC_API_KEY=ant-sk-..." > .env`, and run `uv run agent dafnybench inspect`. This will run 10 samples in Haiku, which is vanishingly small in tokens. You can monitor usage on `console.anthropic.com`.
