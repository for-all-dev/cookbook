...
DAFNY_SYSTEM_PROMPT_V1 = """You are an expert in formal verification using Dafny.
...
DAFNY_SYSTEM_PROMPT_V2 = """You are an expert in formal verification using Dafny.
...
DAFNY_SYSTEM_PROMPT = DAFNY_SYSTEM_PROMPT_V1
